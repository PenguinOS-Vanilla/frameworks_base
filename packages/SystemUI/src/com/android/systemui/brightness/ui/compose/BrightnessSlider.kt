...
fun BrightnessSlider(
    ...
    Row(
        ...
        modifier = if (hasAutoBrightness) Modifier.fillMaxWidth() else modifier,
    ) {
        Slider(
            value = animatedValue,
            ...
            modifier =
                if (hasAutoBrightness) {
                    // When the button is shown, apply the full styling to the slider only
                    // so the background/border don't extend over the toggle button.
                    modifier.weight(1f)
                } else {
                    modifier
                }
...
fun BrightnessSliderContainer(
    ...
    Box(
        ...
        BrightnessSlider(
            ...
            showAutoBrightness = viewModel.showAutoBrightness,
            ...
            onIconClick = {
                viewModel.toggleBrightnessMode()
            },
            modifier =
