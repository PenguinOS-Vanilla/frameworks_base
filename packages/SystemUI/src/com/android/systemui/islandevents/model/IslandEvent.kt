package com.android.systemui.islandevents.model

import android.app.Notification as FrameworkNotification
...
sealed class IslandEvent(open val priority: Int, val id: String) : Comparable<IslandEvent> {
    ...
    data class BiometricUnlock(
        ...
        val sourceName: String = "Fingerprint",
    ...
    data class NotificationAction(val label: CharSequence, val action: FrameworkNotification.Action)

    data class ReplyAction(
        val label: CharSequence,
        val action: FrameworkNotification.Action,
