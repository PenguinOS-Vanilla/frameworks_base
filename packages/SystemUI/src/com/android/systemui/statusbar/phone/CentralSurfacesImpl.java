...
public class CentralSurfacesImpl implements CoreStartable, CentralSurfaces {
    ...
    public CentralSurfacesImpl(
        ...
        mNotificationPanelViewController = SceneContainerFlag.isEnabled() ? null : notificationPanelViewControllerLazy.get();
    ...
    void onLongPressBrightnessChange() {
        if (getNotificationShadeWindowView() != null) {
            getNotificationShadeWindowView().performHapticFeedback(
