...
public class SecureSettingsValidators {
    ...
    static {
        ...
        VALIDATORS.put(Secure.PIF_DATA_TIMESTAMP, ANY_STRING_VALIDATOR);
        VALIDATORS.put(Secure.FETCHED_PIF, ANY_STRING_VALIDATOR);
        VALIDATORS.put(Secure.AUTO_UPDATE_PIF, BOOLEAN_VALIDATOR);
        VALIDATORS.put(Secure.PI_TENSOR_SPOOF, BOOLEAN_VALIDATOR);
    }
}
