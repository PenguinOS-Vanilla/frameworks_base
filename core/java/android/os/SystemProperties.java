...
public class SystemProperties {
    ...
    public static String get(@NonNull String key) {
        ...
        if (PropImitationHooks.isSpoofPropsForProcess()) {
            String spoofed = PropImitationHooks.getSpoofedProperty(key);
    ...
    public static final class Handle {
        ...
        @NonNull public String get() {
            if (PropImitationHooks.isSpoofPropsForProcess()) {
                String spoofed = PropImitationHooks.getSpoofedProperty(mKey);
                if (spoofed != null) return spoofed;
            }
